...
-------
    git clone https://github.com/ceetharamm/spring-cloud-kubernetes.git
...
--------------
    docker build -t ceetharamm/kubernetes-configmap-reload .
...
-----------
    docker push ceetharamm/kubernetes-configmap-reload
